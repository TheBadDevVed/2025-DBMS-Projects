...
export default function BeAdmissionScreen() {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity
            ...
            onPress={() => handleHelpdeskPress("BE_Admission")}
          >
            <Text style={styles.helpdeskButtonText}>BE_Admission_Helpdesk</Text>
          </TouchableOpacity>
        </View>
